  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Telmed <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to TelMed Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using TelMed Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          TelMed Plus is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2024-2025 TelMed+. All rights reserved.</p>
      </div>
    </div>
  );
}
